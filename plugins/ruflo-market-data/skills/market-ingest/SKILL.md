...
allowed-tools: Bash mcp__ruflo__agentdb_hierarchical-store mcp__ruflo__agentdb_hierarchical-recall mcp__ruflo__ruvllm_hnsw_create mcp__ruflo__ruvllm_hnsw_add mcp__ruflo__embeddings_embed
---
...
4. **Store** -- call `mcp__ruflo__agentdb_hierarchical-store` to persist normalized OHLCV data in the `market-data` namespace with symbol and date as keys
