...
argument-hint: "<path>"
allowed-tools: Read Glob Grep mcp__ruflo__agentdb_hierarchical-store mcp__ruflo__agentdb_causal-edge mcp__ruflo__agentdb_semantic-route mcp__ruflo__agentdb_pattern-store mcp__ruflo__embeddings_embed Bash
---
