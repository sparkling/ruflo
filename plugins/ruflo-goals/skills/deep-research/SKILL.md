...
argument-hint: "<topic>"
allowed-tools: mcp__ruflo__memory_store mcp__ruflo__memory_search mcp__ruflo__memory_search_unified mcp__ruflo__agentdb_hierarchical-store mcp__ruflo__agentdb_hierarchical-recall mcp__ruflo__agentdb_pattern-search mcp__ruflo__agentdb_pattern-store mcp__ruflo__neural_predict mcp__ruflo__hooks_intelligence_pattern-search mcp__ruflo__hooks_intelligence_pattern-store mcp__ruflo__task_create mcp__ruflo__task_list mcp__ruflo__task_summary Bash WebSearch WebFetch Read Write
---
...
2. **Search existing knowledge** — call `mcp__ruflo__memory_search_unified` and `mcp__ruflo__agentdb_pattern-search` to check what's already known
...
6. **Store findings** — call `mcp__ruflo__memory_store` with namespace `research` for each key finding
7. **Store patterns** — call `mcp__ruflo__agentdb_pattern-store` for reusable patterns discovered
