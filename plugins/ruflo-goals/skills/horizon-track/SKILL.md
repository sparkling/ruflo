...
allowed-tools: mcp__ruflo__memory_store mcp__ruflo__memory_search mcp__ruflo__memory_list mcp__ruflo__memory_retrieve mcp__ruflo__task_list mcp__ruflo__task_summary mcp__ruflo__progress_check mcp__ruflo__progress_summary mcp__ruflo__agentdb_hierarchical-store mcp__ruflo__agentdb_hierarchical-recall mcp__ruflo__hooks_intelligence_pattern-store mcp__ruflo__session_save mcp__ruflo__session_restore Bash Read Write
---
...
2. **Store horizon** — call `mcp__ruflo__memory_store` with namespace `horizons` and key `horizon-[name]`:
   ```json
   {
     "objective": "...",
     "created": "2026-04-28",
...
3. **Session check-in** — at the start of each session:
   - Recall horizon: `mcp__ruflo__memory_retrieve` key `horizon-[name]` namespace `horizons`
...
6. **Milestone completion** — when a milestone is done:
   ...
   - Store learned patterns via `mcp__ruflo__hooks_intelligence_pattern-store`
