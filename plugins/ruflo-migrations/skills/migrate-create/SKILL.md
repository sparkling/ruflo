...
argument-hint: "<name>"
allowed-tools: Read Write Glob Bash mcp__ruflo__memory_store mcp__ruflo__memory_search mcp__ruflo__agentdb_pattern-search
---
