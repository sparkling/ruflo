...
Steps:
1. `npx @sparkleideas/cli@latest security scan --depth DEPTH`
2. `npx @sparkleideas/cli@latest security cve --check`
3. `npx @sparkleideas/cli@latest security report --format markdown`
