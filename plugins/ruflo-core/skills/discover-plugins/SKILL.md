...
allowed-tools: mcp__ruflo__transfer_plugin-search mcp__ruflo__transfer_plugin-info mcp__ruflo__transfer_plugin-featured mcp__ruflo__transfer_plugin-official mcp__ruflo__transfer_store-search mcp__ruflo__transfer_store-featured mcp__ruflo__transfer_store-trending mcp__ruflo__transfer_store-info mcp__ruflo__guidance_discover mcp__ruflo__guidance_recommend mcp__ruflo__guidance_capabilities mcp__ruflo__mcp_status Bash Read
---
...
2. **Browse marketplace** — call `mcp__ruflo__transfer_plugin-featured` for recommended plugins
3. **Search by need** — call `mcp__ruflo__transfer_plugin-search` with keywords matching your task
4. **Get recommendations** — call `mcp__ruflo__guidance_recommend` with your current task description for personalized suggestions
5. **Check capabilities** — call `mcp__ruflo__guidance_capabilities` to see what each plugin enables
6. **Show details** — call `mcp__ruflo__transfer_plugin-info` for full plugin details
