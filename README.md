> **🍴 `@sparkleideas/ruflo` — the Sparkling fork**
>
> This is **[`@sparkleideas/ruflo`](https://github.com/sparkling/ruflo)**, the Sparkling-maintained fork of **[`ruvnet/ruflo`](https://github.com/ruvnet/ruflo)** (formerly `claude-flow`) — rebuilt from source with bug fixes and current upstream commits.
>
> **Install / run:** `npx -y @sparkleideas/ruflo@latest init`
> **Coming from `claude-flow` / `@claude-flow/cli`?** It's a drop-in replacement — swap the package name and your workflows keep working.
> **Issues & support:** <https://github.com/sparkling/ruflo/issues>
...
[![Star on GitHub](https://img.shields.io/github/stars/sparkling/ruflo?style=for-the-badge&logo=github&color=gold)](https://github.com/sparkling/ruflo)
[![MIT License](https://img.shields.io/badge/License-MIT-yellow?style=for-the-badge)](https://opensource.org/licenses/MIT)
[![Claude Code](https://img.shields.io/badge/Claude%20Code-Plugin-D97757?style=for-the-badge&logoColor=white&logo=anthropic)](https://github.com/sparkling/ruflo)
...
| Issues & Bugs | [GitHub Issues](https://github.com/sparkling/ruflo/issues) |
